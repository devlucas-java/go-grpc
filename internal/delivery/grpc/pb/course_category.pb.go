...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x10.pb.CategoryList\"\x00(\x01\x12Q\n" +
	" CreateCategoryStramBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00(\x010\x01\x12.\n" +
	"\bFindByID\x12\n" +
	".pb.Search\x1a\x14.pb.CategoryResponse\"\x00\x12(\n" +
	"\aListAll\x12\t.pb.Blank\x1a\x10.pb.CategoryList\"\x00B\x1bZ\x19internal/delivery/grpc/pbb\x06proto3"
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	2, // 4: pb.CategoryService.CreateCategoryStramBidirectional:input_type -> pb.CreateCategoryRequest
	4, // 5: pb.CategoryService.FindByID:input_type -> pb.Search
	5, // 6: pb.CategoryService.ListAll:input_type -> pb.Blank
	...
	0, // 9: pb.CategoryService.CreateCategoryStramBidirectional:output_type -> pb.Category
	1, // 10: pb.CategoryService.FindByID:output_type -> pb.CategoryResponse
	3, // 11: pb.CategoryService.ListAll:output_type -> pb.CategoryList
